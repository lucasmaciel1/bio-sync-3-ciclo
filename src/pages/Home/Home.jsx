    ...
    <div className="min-h-screen bg-gray-100  font-montserrat">
      <header className="bg-[url('/public/back-header-map-V3.jpg')] bg-center bg-cover h-32">
        <nav className="container mx-auto px-6 py-3 flex justify-between items-center">
          ...
          <div>
            <p className="text-white-1">Faça<button onClick={openLoginModal} className="ml-2 px-2 font-bold text-white-1 rounded hover:text-green-1 hover:underline">Login</button> ou</p>
            <Link to="/" className="font-bold text-white-1 rounded hover:text-green-1 hover:underline">Cadastre-se</Link>
          </div>
        </nav>
      </header>
    ...
    <h2 className="text-3xl font-bold mt-12 mb-6 text-center">Redes Sociais</h2>
        <div className="flex space-x-16 justify-center p-12">
          <a href="/" className="text-gray-600 hover:text-gray-800">
            <img src={logoinstagram} alt="Instagram" className="h-24 w-24 transition-transform transform hover:scale-105 cursor-pointer" />
          </a>
          <a href="/" className="text-gray-600 hover:text-gray-800">
            <img src={logotiktok} alt="TikTok" className="h-24 w-24 transition-transform transform hover:scale-105 cursor-pointer" />
          </a>
          <a href="/" className="text-gray-600 hover:text-gray-800">
            <img src={logoyoutube} alt="YouTube" className="h-24 w-24 transition-transform transform hover:scale-105 cursor-pointer" />
          </a>
        </div>
